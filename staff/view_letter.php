...
$content = $MainView->document_letter($_GET['content']);
	$rollnumber = array();
	if (isset($rollnumber[0]->f_st_roll)) {
		$roll_n = $rollnumber[0]->f_st_roll;
	}else if ($content->roll) {
		$roll_n = $content->roll;
	}else{
		$roll_n = false;
	}
	if ($MainView->check_if_student_is_polytechnic($roll_n)) {
		echo "<img src='../img/letter_header_pol.png' style='width:100%;'";
	}else{
		echo "<img src='../img/letter_header.png' style='width:100%;'";
	}
	...
	switch ($_GET['type']) {
		case 1:
			...
			$status = "Director of Academic Services";
			echo "<div class='content'><center><h1>TO WHOM IT MAY CONCERN</h1></center><br><br><br>";
		...
		//	echo "<br><br><br><br><br>";
			...
			//echo "<center><h1><br>TO WHOM IT MAY CONCERN</h1></center><br><br><br>";
			echo "<p>I, the undersigned, <b>RUGWIZANGOGA Emmanuel</b>, ".$status." of Kigali Independent University ULK / Kigali campus, hereby recommend <b> Mrs/Mr. ".$content->student_name."</b>, a ".$content->nationality." <span class='editable'> citizen applying for admission at our University for the Academic Year 2020-2021 for help from your office.</p>";
